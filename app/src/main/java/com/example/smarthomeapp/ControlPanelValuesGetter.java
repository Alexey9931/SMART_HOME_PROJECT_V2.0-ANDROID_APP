...
//            DisplayWeathForecast();
    ...
    {
        try {
            HomeFragment.HOME_TEMP.setText(TemperatureList.get(TemperatureList.size() - 1));
            HomeFragment.HOME_HUM.setText(HumidityList.get(HumidityList.size() - 1));
            HomeFragment.PRESSURE.setText(PressureList.get(PressureList.size() - 1));

...
public class WeatherStationValuesGetter extends AsyncTask<String,Void,String> {
    ...
    public static List<String> RainFallList = new ArrayList<>();
    public static List<String> WindDirectList = new ArrayList<>();
    public static List<String> WindSpeedList = new ArrayList<>();
    ...
    public WeatherStationValuesGetter(Context ctx){ context = ctx; }
    ...
    public void FillAllParams(String result)
    {
        ...
        while (i < result.length())
        {
            ...
            Result = result.substring(k,i);
            WindDirectList.add(id-1, Result);
            i++;
            k = i;
            //RainFall
            while(result.charAt(i) != '|')
            ...
            Result = result.substring(k,i);
            RainFallList.add(id-1, String.valueOf(Float.parseFloat(Result)));
            i++;
            k = i;
            //TimeStamp
            while(result.charAt(i) != '|')
...
//                    time_error.setVisibility(View.INVISIBLE);
    ...
    public void DisplayWeathForecast()
    {
        ...
        List<String> PART1_temp = new ArrayList<>();//ул темп
        List<String> PART2_temp = new ArrayList<>();
        List<String> PART3_temp = new ArrayList<>();
        List<String> PART4_temp = new ArrayList<>();
        ...
        while(num < (WeatherStationValuesGetter.TemperatureList.size()/total_amount))
        {
            PART1_temp.add(ind, WeatherStationValuesGetter.TemperatureList.get(num));
            PART1_pres.add(ind, ControlPanelValuesGetter.PressureList.get(num));
            PART1_rain.add(ind, WeatherStationValuesGetter.RainFallList.get(num));
            PART1_speed.add(ind, WeatherStationValuesGetter.WindSpeedList.get(num));
            num++;
            ind++;
        }
        street_temp.add(0,calculateDetails.CalculateAverage(PART1_temp));
        ...
        data.add(0, WeatherStationValuesGetter.TimestampList.get(0).substring(0,5)+" - "+ WeatherStationValuesGetter.TimestampList.get(WeatherStationValuesGetter.TimestampList.size()/total_amount).substring(0,5));
        ind = 0;
        while(num < (2* WeatherStationValuesGetter.TimestampList.size()/total_amount))
        {
            PART2_temp.add(ind, WeatherStationValuesGetter.TemperatureList.get(num));
            PART2_pres.add(ind, ControlPanelValuesGetter.PressureList.get(num));
            PART2_rain.add(ind, WeatherStationValuesGetter.RainFallList.get(num));
            PART2_speed.add(ind, WeatherStationValuesGetter.WindSpeedList.get(num));
            num++;
            ind++;
        }
        street_temp.add(1,calculateDetails.CalculateAverage(PART2_temp));
        ...
        data.add(1, WeatherStationValuesGetter.TimestampList.get(1+ WeatherStationValuesGetter.TimestampList.size()/total_amount).substring(0,5)+" - "+ WeatherStationValuesGetter.TimestampList.get(1+2* WeatherStationValuesGetter.TimestampList.size()/total_amount).substring(0,5));
        ind = 0;
        while(num < (3* WeatherStationValuesGetter.TimestampList.size()/total_amount))
        {
            PART3_temp.add(ind, WeatherStationValuesGetter.TemperatureList.get(num));
            PART3_pres.add(ind, ControlPanelValuesGetter.PressureList.get(num));
            PART3_rain.add(ind, WeatherStationValuesGetter.RainFallList.get(num));
            PART3_speed.add(ind, WeatherStationValuesGetter.WindSpeedList.get(num));
            num++;
            ind++;
        }
        street_temp.add(2,calculateDetails.CalculateAverage(PART3_temp));
        ...
        data.add(2, WeatherStationValuesGetter.TimestampList.get(1+2* WeatherStationValuesGetter.TimestampList.size()/total_amount).substring(0,5)+" - "+ WeatherStationValuesGetter.TimestampList.get(1+3* WeatherStationValuesGetter.TimestampList.size()/total_amount).substring(0,5));
        ind = 0;
        while(num < (4* WeatherStationValuesGetter.TimestampList.size()/total_amount))
        {
            PART4_temp.add(ind, WeatherStationValuesGetter.TemperatureList.get(num));
            PART4_pres.add(ind, ControlPanelValuesGetter.PressureList.get(num));
            PART4_rain.add(ind, WeatherStationValuesGetter.RainFallList.get(num));
            PART4_speed.add(ind, WeatherStationValuesGetter.WindSpeedList.get(num));
            num++;
            ind++;
        }
        street_temp.add(3,calculateDetails.CalculateAverage(PART4_temp));
        ...
        data.add(3, WeatherStationValuesGetter.TimestampList.get(1+3* WeatherStationValuesGetter.TimestampList.size()/total_amount).substring(0,5)+" - "+ WeatherStationValuesGetter.TimestampList.get(WeatherStationValuesGetter.TimestampList.size()-1).substring(0,5));
